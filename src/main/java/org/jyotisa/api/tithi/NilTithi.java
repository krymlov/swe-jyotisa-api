...
/**
 * The "not a tithi" member - a Null Object, so that a lookup which cannot name one has
 ...
 * part of the <b>contract</b> of ITithi rather than of any one implementation. A caller
 ...
 * <p>
 * Its accessors stay {@code null}: a non-tithi has no lord and no element, and inventing one
 ...
 * @version 1.0, 2026-08
 */
public enum NilTithi implements ITithi {
    NIL;
